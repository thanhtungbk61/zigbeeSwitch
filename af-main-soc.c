...
{
//	emAfFragmentationIncomingMessage(type,apsFrame,emberGetSender(),message,message);
	emberAfCorePrintln("emberIncomingMessageHandler--EmberIncomingMessageType:%d",type);
  uint8_t lastHopLqi;
  int8_t lastHopRssi;
