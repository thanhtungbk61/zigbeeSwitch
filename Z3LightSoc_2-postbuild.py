...
def OTA():
    if not '"%PROJECT_DIR%\..\\..\\..\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 1 --manuf-id 0x1002 --image-type 0 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL Z3LightSoc_2"':
        sys.exit(0)
    print " "
    ...
    IMAGE_BUILDER = '"%PROJECT_DIR%\..\\..\\..\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 1 --manuf-id 0x1002 --image-type 0 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL Z3LightSoc_2"'.replace("\t", "\\t")
