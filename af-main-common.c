...
//	{
//		emberAfCorePrintln("message[%d]:%d",i,messageContents[i]);
//	}
//	emberAfCorePrintln("emAfIncomingMessageHandler");
  EmberNodeId sender = emberGetSender();
//  bool frag= emAfFragmentationIncomingMessage(type,apsFrame,emberGetSender(),&messageContents,&messageLength);
//  if(frag == true)
//  {
//	  emberAfDebugPrintln("emAfFragmentationIncomingMessage");
//	  return;
//  }
