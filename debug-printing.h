...
// Printing macros for cluster: Manager
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_MANAGER)
#define emberAfManagerPrint(...) emberAfPrint(EMBER_AF_PRINT_MANAGER, __VA_ARGS__)
#define emberAfManagerPrintln(...) emberAfPrintln(EMBER_AF_PRINT_MANAGER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfManagerFlush()
#define emberAfManagerDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_MANAGER) ) { x; }
#define emberAfManagerPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_MANAGER, (buffer), (len), (withSpace))
#define emberAfManagerPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_MANAGER, (buffer))
#else
#define emberAfManagerPrint(...)
#define emberAfManagerPrintln(...)
#define emberAfManagerFlush()
#define emberAfManagerDebugExec(x)
#define emberAfManagerPrintBuffer(buffer, len, withSpace)
#define emberAfManagerPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_MANAGER)
